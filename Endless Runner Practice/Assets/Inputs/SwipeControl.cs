...
//     version 1.14.0
//     from Assets/Inputs/SwipeControl.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Inputs/SwipeControl.inputactions".
/// </summary>
/// <remarks>
...
public partial class @SwipeControl: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Player"",
            ""id"": ""9969a777-d1d6-43d6-893a-622a96324356"",
            ""actions"": [
                {
                    ""name"": ""Touch"",
                    ""type"": ""Value"",
                    ""id"": ""4ee12174-a009-4d96-9ced-6a2420fce9d9"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""5b352f6e-b138-4ec4-948c-36a81a51400a"",
    ...
    ~@SwipeControl()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, SwipeControl.Player.Disable() has not been called.");
    }
    ...
    public struct PlayerActions
    {
        ...
        /// </summary>
        public PlayerActions(@SwipeControl wrapper) { m_Wrapper = wrapper; }
        /// <summary>
